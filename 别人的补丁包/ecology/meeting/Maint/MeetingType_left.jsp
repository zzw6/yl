...
<input type="hidden" name="pageId" id="pageId" value="<%= PageIdConst.MT_MeetingType%>"/>
	...
	String backfields = " id,name,approver,approver1,desc_n,subcompanyid, catalogpath, dsporder,istickling ";
	...
	tableString +=  "		<operates>"+
					"		<popedom column=\"id\" otherpara=\"6+column:subcompanyid+"+user.getUID()+"+"+detachable+"+column:istickling\" transmethod=\"weaver.meeting.Maint.MeetingTransMethod.checkTypeOperate\"></popedom> "+
					...
					"		<operate href=\"javascript:onMember();\" text=\""+SystemEnv.getHtmlLabelName(2106,user.getLanguage())+"\" target=\"_self\" index=\"3\"/>"+
					"		<operate href=\"javascript:onCaller();\" text=\""+SystemEnv.getHtmlLabelName(2152,user.getLanguage())+"\" target=\"_self\" index=\"4\"/>"+
					"		</operates>";
