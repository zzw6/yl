...
<table id="topTitle" cellpadding="0" cellspacing="0">
	...
	<FORM id="weaverA" name="weaverA" action="MeetingTicklingList.jsp" method="post"  >
...
<%
String backfields = "a.id,a.name,a.creater,a.caller,a.createdate,a.createtime,b.name as meetingtypename,c.departmentid,d.queCount1,d.queCount2,d.queCount3,d.queCount4,d.Quecount5,d.queCount";
String fromSql  = " meeting a, Meeting_Type b, HrmResource c,MeetingAppraise d   ";
String sqlWhere = " where a.meetingtype = b.id  and a.creater = c.id and a.id = d.meetingId and (a.meetingstatus = 5 or a.meetingstatus = 2) ";
sqlWhere += " and b.isTickling = '1' ";
...
if(t_rsCount > 0) {
	...
	if(rsCount <= 0){
		...
		if(!"".equals(tempSubids)){
			sqlWhere += " and (c.subcompanyid1 in ("+ tempSubids +") or a.creater = " + currUser + " or a.caller = "+ currUser +" )";
		}
	}
}else if(HrmUserVarify.checkUserRight("Meeting:EvalReport", user)){
	sqlWhere += " and (c.departmentid = "+ userDep +" or a.creater = " + currUser + " or a.caller = "+ currUser +" ) ";
}else{
...
tableString =" <table instanceid=\"MeetingTicklingListTable\" tabletype=\"none\" pagesize=\"20\" >"+
             ...
             "			<head>"+
             "				<col width=\"10%\"   text=\"会议类型\" 		column=\"meetingtypename\" 	orderkey=\"meetingtypename\" 		/>"+
             "				<col width=\"20%\"   text=\"会议名称\" 		column=\"id\" 				orderkey=\"id\" 			transmethod=\"com.weavernorth.meeting.TablePageHtml.getMeetingName\" />"+
             "				<col width=\"10%\"   text=\"创建部门\" 		column=\"departmentid\" 	orderkey=\"departmentid\"  	transmethod=\"weaver.hrm.company.DepartmentComInfo.getDepartmentname\" />"+
             "				<col width=\"6%\"    text=\"创建人\" 		column=\"creater\" 			orderkey=\"creater\" 		transmethod=\"weaver.meeting.Maint.MeetingTransMethod.getMeetingResource\" />"+
           	 "				<col width=\"6%\"    text=\"主持人\" 		column=\"caller\" 			orderkey=\"caller\" 		transmethod=\"weaver.meeting.Maint.MeetingTransMethod.getMeetingResource\"/>"+
		 	 "				<col width=\"6%\"    text=\"提前下发通知\" 						column=\"queCount4\"  				orderkey=\"queCount4\"			/>"+
             "				<col width=\"6%\"    text=\"决议下发及时\" 						column=\"queCount5\"  				orderkey=\"queCount5\" 			/>"+
             "				<col width=\"10%\"   text=\"会议前是否有明确的议程及材料\" 				column=\"queCount1\"  				orderkey=\"queCount1\"  		/>"+
             "				<col width=\"10%\"   text=\"会议主持人是否能有效把控会议进程，引导会议进行\" 	column=\"queCount2\"				orderkey=\"queCount2\"			/>"+
             "				<col width=\"10%\"   text=\"会议结束时是否明确了会议决议落实责任人及时间\" 	column=\"queCount3\"				orderkey=\"queCount3\"			/>"+
             "				<col width=\"6%\"    text=\"得分\" 		   					column=\"queCount\"					orderkey=\"queCount\"			/>"+
             "			</head>"+
     		 "		</table>";
 %>
...
function view(id)
{
	if(id!="0" && id !=""){
		...
		diag_vote.Title = "会议基本信息";
		diag_vote.URL = "/meeting/modify/MeetingViewTab.jsp?meetingid="+id+"&viewtype=viewpage";
		diag_vote.show();
	}
}
