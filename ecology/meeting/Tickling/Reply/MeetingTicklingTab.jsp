...
String mouldID = "";
String title = "";
if("MeetingTicklingList".equals(_fromURL)){
	mouldID = MouldIDConst.getID("meeting");
	title = "会议评估报表";
	url = "/meeting/Tickling/Reply/MeetingTicklingList.jsp";
}else if("StayAppraiseMeeting".equals(_fromURL)){
	mouldID = MouldIDConst.getID("meeting");
	title = "待评估的会议";
	url = "/meeting/Tickling/Reply/StayAppraiseMeeting.jsp";
}else if("MeetingTicklingAdd".equals(_fromURL)){
	mouldID = MouldIDConst.getID("meeting");
	title = "会议评估";
	url = "/meeting/Tickling/Reply/MeetingTicklingAdd.jsp?meetingId="+meetingId;
}
%>
