...
String mouldID = "";
String title = "";
if("MeetingQueSeting".equals(_fromURL)){
	mouldID = MouldIDConst.getID("meeting");
	title = "会议问题设置";
	url = "/meeting/Tickling/MeetingQueSeting.jsp";
}else if("MeetingMarkSeting".equals(_fromURL)){
	mouldID = MouldIDConst.getID("meeting");
	title = "会议问题分数设置";
	url = "/meeting/Tickling/MeetingMarkSeting.jsp?type="+type+"&queId="+queId;
}
%>
