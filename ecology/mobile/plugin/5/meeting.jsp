...
<script type="text/javascript">
	...
	function getMeetHtml(m){
		...
		var temp = '<div class="weui-cell weui-cell_access" onClick="viewMeeting('+m.id+','+m.meetingover+')">'+
			       ' 	<div class="weui-cell__hd">'+m.begintime+'<br/>'+m.endtime+'<br/>'+m.userType+'<br/><span style="font-size:12px;">[主持人]</span></div>'+

				   '     <div class="weui-cell__bd">'+
				   '       <p>'+m.name+'</p>'+
				   '       <p class="mt-address">'+m.roomname+'</p>'+
				   '<p style="font-size:12px;margin-top: 20px;color: red;" onClick="event.cancelBubble = true;openuser('+m.createid+')">'+m.create+'</p>     </div>'+
