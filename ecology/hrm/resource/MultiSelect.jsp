					...
					if(filedvalue.length()>0){
						if(sqlwhere.length()>0){
							if(filedname.equals("roleid")){
								...
								if(filedname.equals("lastname")||filedname.equals("jobtitle")){
									sqlwhere += " and hr."+filedname+" like '%"+filedvalue+"%'";
								}else{
									if(filedname.equals("subcompanyid"))filedname="subcompanyid1";
			...
			<div id="colShow">
					     ...
					     <wea:item><%=SystemEnv.getHtmlLabelName(82531,user.getLanguage())%></wea:item>
					  	 <wea:item>
							...
							%>
								...
								<wea:item>
											<input class=inputstyle id=jobtitle name=jobtitle maxlength=60 value="<%=filedvalue %>">
								<!-- 
				...
				<%} %>
					...
					<div class="e8_box_middle ps-container" id="src_box_middle" style="width: 346px;">
						...
						<%}else{ %>
						<table class="e8_box_source" style="border-collapse: collapse;border-spacing:0px;width: 100%;table-layout:fixed;">
							<tbody>
							</tbody>
						</table>
						<%} %>
				...
				<div class="e8_box_d">
							...
							<tr>
								<td style="height: 30px">
									<span id="searchblockspan">
										<span class="searchInputSpan" style="position:relative;width: 325px">
											...
											<input type="text" class="searchInput middle" id="flowTitle1" name="flowTitle1" value="<%=qname %>" onkeyup="jsTargetSearch(this)" style="vertical-align: top;width: 290px">
					...
					<div class="e8_box_middle ps-container" id="dest_box_middle" style="width: 346px">
						<table id="e8_dest_table" class="e8_box_target" style="border-collapse: collapse;border-spacing:0px;width: 100%;table-layout:fixed;">
							<tbody></tbody>
						</table>
					</div>
					<div class="e8_box_src e8_box_bottommenu" style="width: 257px;display: none;">
						<table style="width: 100%;">
							<tr>
								<td style="text-align: center;"><%=SystemEnv.getHtmlLabelName(31503,user.getLanguage())%>&nbsp;<span id="e8_box_target_num11" style="text-decoration:underline;">0</span>&nbsp;人</td>
							</tr>
						</table>
					</div>
				</div>
...
<script type="text/javascript">
	...
	var i = 0;
	function expandZH(){
		var height = dialog.Height-135-E8EXCEPTHEIGHT;
		jQuery(".e8_box_middle").css("height",height);
		jQuery("#dest_box_middle").css("height",dialog.Height-135);
