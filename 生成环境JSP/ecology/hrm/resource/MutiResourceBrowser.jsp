...
for(ConditionField conditionField : lsConditionField ){
	...
	if(subcompanyid.length()>0){
		if(wfparam.length()>0)wfparam+=" and ";
		wfparam += "subcompanyid="+subcompanyid;
	}
	
	if(departmentid.length()>0){
		if(wfparam.length()>0)wfparam+=" and ";
		wfparam += "departmentid="+departmentid;
	}
