...
//查看通知人员 阅读情况
function onShowInform(meetingid){
	showDialog("/meeting/data/MeetingOthTab.jsp?toflag=Inform&meetingid="+meetingid,"<%="通知阅读情况"%>", 600, 500);
}
//查看签到人员状态
function onShowSignIn(meetingid){
	showDialog("/meeting/data/MeetingParticipants.jsp?toflag=MeetingSign&meetingid="+meetingid,"<%="会议签到情况"%>", 850, 600);
}
