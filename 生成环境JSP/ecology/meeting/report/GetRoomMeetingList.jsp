	...
	//修改每页显示条数为 4 by lq 2015-11-27	
     ...
     String tableString = "";
   	tableString =" <table instanceid=\"meetingTable\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+ 
                          ...
                          "			</head>"+
                          "		<operates>"+
						  "		  <popedom column=\"id\" otherpara=\"column:caller+"+userid+"+"+cancelRight+"+column:cancel+column:meetingstatus+column:enddate+column:endtime+column:isdecision\" transmethod=\"weaver.meeting.Maint.MeetingTransMethod.checkMtnCnclOperate\"></popedom> "+
...
//会议主持人点击显示人员信息 lq  2016-1-14  start
...
{  
	...
	//获取父页面div高度
	var height = $("#tablediv",parent.document).height()+30;
	pointerXYByHeightDeviation(event,height);
} 
/*
